...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      // Detect base path so fetch works in any subfolder (e.g. /gym-web-v2/)
      ...
      async function validateToken() {
        ...
        try {
          const res  = await fetch(basePath + '/api/auth/validate-reset-token.php?token=' + encodeURIComponent(token));
      ...
      document.getElementById('resetForm').addEventListener('submit', async function(e) {
        ...
        try {
          const res  = await fetch(basePath + '/api/auth/reset-password.php', {
            method:  'POST',
